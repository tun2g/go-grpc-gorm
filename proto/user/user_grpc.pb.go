...
const (
	UserController_GetUserInfo_FullMethodName = "/user.UserController/GetUserInfo"
)
...
func (c *userControllerClient) GetUserInfo(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*GetUserInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, UserController_GetUserInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserController_GetUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserController_GetUserInfo_FullMethodName,
	}
...
var UserController_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/api/user/user.proto",
}
